...
export default async function CustomersPage() {
  ...
  return (
    <main className="admin-main">
      ...
      <div className="page-heading"><div><h1>Customers</h1><p className="lede">Tenant-scoped customer records and lifecycle state.</p></div><Link className="primary-button" href="/admin/imports/new">Dry-run import</Link></div>
